      ...
      case "APPROVED":
        return (
          <>
            ...
            <span className="approved">APPROVED</span> BY ADMIN!
          </>
        );
      case "REJECTED":
        return (
          <>
            ❌ SORRY! YOUR REQUEST HAS BEEN{" "}
            <span className="rejected">REJECTED</span> BY ADMIN.
          </>
        );
      case "PENDING":
        return (
          <>
            ⏳ YOUR REQUEST IS{" "}
            <span className="pending">PENDING</span>. Please wait for admin
            approval.
          </>
        );
      default:
